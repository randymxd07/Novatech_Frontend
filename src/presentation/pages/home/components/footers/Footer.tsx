...
export const Footer = () => {
    ...
    return (
        ...
        <footer className="bg-white dark:bg-gray-800 select-none">
            ...
            <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div className="text-center">
                    ...
                    <span className="block text-sm text-center text-gray-500 dark:text-gray-400">
                        © 2024-2025 NOVATECH™. Reservados todos los derechos. Construido con <a href="https://tailwindcss.com" className="text-blue-600 hover:underline dark:text-blue-500">Tailwind CSS</a>.
                    </span>
                    ...
                    <ul className="flex justify-center mt-5 space-x-5">
                        ...
                        ===============*/}
                        <li>
                            <a className="cursor-pointer text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
